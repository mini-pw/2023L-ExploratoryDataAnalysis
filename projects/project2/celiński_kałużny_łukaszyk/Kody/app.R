...
# co jeszcze trzeba zrobić (dopisujcie swoje pomysly, jak coś zrobicie w apce to piszcie komentarz, albo usuwajcie wiersz)

#0. uzupełnić chociaż trochę brakujące dane w ramce finalna_wybrakowana
#1. ogarnac te wykresy oczywiście
#1a) nie wiem jak zrobić wykres kolumnowy dotyczący gatunków, bo one są w 3 kolumnach
#1b) wykres budżetowy - gotowe
#1c) wykresy dla aktorów wrzucić 
#1d) na wykresie czasow trwania ogarnać kolorki (Ania cos mowila jak to zrobić) i legendę po PL
#2. uatrakcyjnić wizualnie wygląd apki (jakieś ładne napisy, tło, spinnery)
#3. napisać raport
#4. nagrać filmik
#5. ?

wykresowa <- read.csv("ramki_danych/paczka_ramek_do_obrobki/finalna_wybrakowana.csv")
wykresowa <- wykresowa %>% 
