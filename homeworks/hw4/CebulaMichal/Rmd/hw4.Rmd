...
Celem pracy domowej było sprawdzenie znajomości tworzenia map z wykorzystaniem narzędzi w języku *R* lub *Python* i polegała ona na przedstawieniu dowolnych danych w poprawny sposób z wykorzystaniem mapy.

## Dane

Utworzona wizualizacja dotyczyła danych o wynikach głosowania na listy Sejmowe, w wyborach parlamentarnych w Polsce w 2019. roku, udostępnionych przez *Państwową Komisję Wyborczą (PKW)*. Dane są dostępne do pobrania pod linkiem: 

https://sejmsenat2019.pkw.gov.pl/sejmsenat2019/pl/dane_w_arkuszach.

Dane geograficzne niezbędne do utworzenia mapy pochodziły z *Państwowego Rejestru Granic (PRG)* i są dostępne do pobrania pod linkiem:
...
Na mapie administracyjnej Polski, kolorem przedstawiono udział procentowy głosów unieważnionych z powodu niepostawienia znaku 'X' obok nazwiska żadnego kandydata w stosunku do wszystkich ważnych kart, w wyborach parlamentarnych w Polsce w 2019. roku,  według poszczególnych powiatów.
...
Tworzenie wizualizacji na mapach na stanowi istotne doświadczenie w pracy z danymi. Wizualizacje takie jak powyższa mogą stanowić niezastąpione źródło informacji na różne tematy, w tym społeczno-polityczne.
